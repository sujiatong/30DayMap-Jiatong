...
ggplot() +
  ...
  geom_sf(data = qing_1911, aes(fill = "1911 (3rd year of the Xuantong)"), color = NA, alpha = 0.5, size = 0.2) +
  ...
  scale_fill_manual(
    values = c("1820 (25th year of the Jiaqing)" = "#d8c295", "1911 (3rd year of the Xuantong)" = "#7d5a50"),
    name = "Time Period"
  ) +
  ...
  labs(
    ...
    subtitle = "1820 (25th year of the Jiaqing) vs 1911 (3rd year of the Xuantong)",
